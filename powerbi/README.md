...
![Model performance](screenshots/page1_model_performance.png)
...
![Calibraition](screenshots/page2_calibration.png)
...
![Predictions](screenshots/page3_predictions_explorer.png)
...
![Upsets](screenshots/page4_upsets_and_confidence.png)
...
![Team view](screenshots/page5_team_view.png)

**6 - All teams Elo**
Elo rating for every team over time, from `team_elo_history.csv`.

![All teams elo](screenshots/page6_all_teams_elo.png)
...
![Upcoming predictions](screenshots/page7_upcoming_predictions.png)
